    ...
    return (
        <div>
            <footer className="footer bg-[#111827] text-white p-10">
                <aside>
                    ...
                    <p>
                        DiscussHub
                        <br />
                        Connecting people, one discussion at a time.
                    </p>
                </aside>
                <nav>
                    <h6 className="footer-title">Forum Sections</h6>
                    <a className="link link-hover">General Discussion</a>
            ...
            <footer className="footer footer-center bg-black text-white p-4">
                <aside>
                    <p>Copyright © {new Date().getFullYear()} - All rights reserved by BISTRO BOSS Forum</p>
                </aside>
            </footer>
        </div>
    );
